...
def test_cache_put_get_round_trip(cache_temp_site_with_input):
...
def test_cache_miss_on_changed_input(cache_temp_site_with_input):
...
def test_cache_miss_on_changed_recipe(cache_temp_site_with_input):
...
def test_cache_reuse_count_increments(cache_temp_site_with_input):
...
def test_cache_metadata_tracking(cache_temp_site_with_input):
...
def test_cache_list(cache_temp_site):
...
def test_cache_clear(cache_temp_site_with_input):
...
def test_action_recipes_not_cached(cache_temp_site_with_input):
...
def test_cache_directory_structure(cache_temp_site_with_input):
