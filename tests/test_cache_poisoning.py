...
def test_cache_poisoning_outputs_json(cache_temp_site):
...
def test_cache_poisoning_seal_tampered(cache_temp_site):
...
def test_cache_validation_allows_valid_reuse(cache_temp_site):
