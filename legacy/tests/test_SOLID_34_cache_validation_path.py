...
def test_cache_get_is_single_validation_path(cache_temp_site):
...
def test_cache_validation_prevents_bypass(cache_temp_site):
...
def test_cache_get_validation_steps(cache_temp_site):
...
def test_cache_rejects_missing_seal_version(cache_temp_site):
...
def test_cache_rejects_unsupported_seal_version(cache_temp_site):
